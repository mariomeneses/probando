...
$(document).ready(function() {
 ...
 $("#btnSubmitForm").click(function() { 
      ...
      var proceed = true;
      if(user_name==""){ 
          $('input[name=nameInput]').css('border-color','red'); 
          proceed = false;
      }
      if(user_email==""){ 
          $('input[name=emailInput]').css('border-color','red'); 
          proceed = false;
      }
      if(user_message=="") {  
          $('textarea[name=descriptionInput]').css('border-color','red'); 
          proceed = false;
      }
      ...
      if(proceed) 
      {
          ...
          post_data = {'nameInput':user_name, 'emailInput':user_email, 'descriptionInput':user_message};
